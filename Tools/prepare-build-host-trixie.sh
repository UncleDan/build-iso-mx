#!/bin/bash
# prepare-build-host-trixie.sh by Daniele Lolli (UncleDan) feat. Claude AI - Release v5 - 2026-09-22 11-20-54
#
# prepare-build-host-trixie.sh - v5 (2026-09-22)
#
...
#   unpack the tree preserving its ~240 symlinks, git to track the flavour, tmux
